...
class PasswordManagerWidget(QWidget):
    ...
    def _encrypt(self, plaintext, key):
        ...
        cipher = Cipher(algorithms.AES(key[:32]), modes.GCM(nonce), backend=default_backend())
    ...
    def _decrypt(self, ciphertext, key):
        ...
        # Ensure the length of the base64-encoded string is a multiple of 4 by adding padding if needed
